...
def query_llm_for_action(temp):
    prompt = f"The drone's temperature is {temp:.2f}°C. Should it land or continue hovering? reply with only 'land' or 'hover' based on the temperature and condition."
